...
from transport import transport_receive, transport_send
...
def protocol_server(dict_client):
    ...
    try:
        if (dict_client['action'] == 'presence' or dict_client['action'] == 'quit')\
                and dict_client['time'] and dict_client['user']['account_name']:
        ...
        dict_server['alert'] = 'неправильный запрос'
        return dict_server
